...
<div class="h-screen flex">
    <div class="flex w-1/3 bg-gradient-to-tr from-green-800 to-green-700 i justify-around items-center">
        <div>
            <h1 class="text-white font-bold text-4xl font-sans">Very secure app</h1>
            <p class="text-white mt-1">CVE-2021-44228</p>
    ...
    <div class="flex w-2/3 justify-center items-center bg-white">
        <form class="bg-white" method="POST" action="/login">
            ...
            <span class="text-sm ml-2 hover:text-green-500 cursor-pointer">Forgot Password ?</span>
        </form>
    </div>
</div>
</body>
